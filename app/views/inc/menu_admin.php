 <li class="nav-item <?php if ($url[0]=='dashboard' || $url[0]=='dashboardGerencial') echo 'menu-open'; else echo ''; ?>">
  ...
  <li class="nav-item <?php if ($url[0]=='estadisticas' || $url[0]=='ingresosLugarEntrenamiento') echo 'menu-open'; else echo ''; ?>">
    <a href="#" class="nav-link <?php if ($url[0]=='estadisticas' || $url[0]=='ingresosLugarEntrenamiento') echo 'active'; else echo ''; ?>">
      ...
      <p>Estadísticas<i class="fas fa-angle-left right"></i></p>
    </a>
    <ul class="nav nav-treeview">
      <li class="nav-item">
      ...
      <li class="nav-item">
        <a href="<?php echo APP_URL."ingresosLugarEntrenamiento/" ?>" class="nav-link <?php if ($url[0]=='ingresosLugarEntrenamiento') echo 'active'; else echo ''; ?>">
          <i class="nav-icon far fa-circle text-info"></i>
          <p>Consolidado por período</p>
        </a>
      </li>
      <li class="nav-item">
        <a href="<?php echo APP_URL."reporteIngresosMorames/" ?>" class="nav-link <?php if ($url[0]=='reporteIngresosMorames') echo 'active'; else echo ''; ?>">
          <i class="nav-icon far fa-circle text-info"></i>
          <p>Detalle ingresos y mora</p>
        </a>
      </li>
    </ul>
  </li>
  ...
  <li class="nav-item">
    <a href="<?php echo APP_URL."imagenesList/" ?>" class="nav-link <?php if ($url[0]=='imagenesList' || $url[0]=='imagenesUpdate') echo 'active'; else echo ''; ?>">
      <i class="nav-icon far fa-image text-info"></i>
      <p>Imagenes</p>
    </a>
  </li>
