        ...
        <div class="card card-default">
          <div class="card-header">
            ...
            <div class="card-tools d-flex align-items-center flex-wrap" style="gap:6px;">
              ...
              <button onclick="exportarTablaAExcel('tablaDatos','ADFPL-Estadisticas-<?php echo date('Y-m'); ?>')"
                      class="boton-icono"
                      style="background-image: url('<?php echo APP_URL; ?>app/views/imagenes/iconos/Excel.png');"
                      title="Exportar a Excel"></button>
              <button onclick="exportarTablaAPDF('tablaDatos','ADFPL-Estadisticas-<?php echo date('Y-m'); ?>')"
                      class="boton-icono"
...
$(function () {
  ...
  $("#tablaDatos").DataTable({
    ...
    "autoWidth":    false,
    "responsive":   true,
    "order":        [[8, "asc"]], // ordenar por % recaudado asc por defecto
    "columnDefs": [
      { "orderable": false, "targets": [8] } // la col progress no es ordenable por valor visual
    ],
    "language": {
