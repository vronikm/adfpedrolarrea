<?php	
    ...
    $pdf->SetXY( $x, $y ); $pdf->SetFont( "Arial", "B", 11 ); $pdf->Cell( 260, 8, mb_convert_encoding("ACADEMIA DE FÚTBOL PEDRO LARREA", 'ISO-8859-1', 'UTF-8'),0, 0, 'C'); $y+=5;
    ...
    $pdf->Output($datos['pago_recibo'].".pdf","I","T");
