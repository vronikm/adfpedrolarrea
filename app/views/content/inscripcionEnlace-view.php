                        ...
                        <div class="col-md-8 offset-md-2">
                            ...
                            <div class="card card-primary">
                                ...
                                <div class="card-body">
                                    ...
                                    <form id="formGenerarEnlace" autocomplete="off">
                                        <div class="row">
                                            <!-- Sede -->
                                            <div class="col-md-6">
                                    ...
                                    <div id="enlaceResultado" class="enlace-resultado">
                                        ...
                                        <div class="row mt-3">
                                            ...
                                            <div class="col-md-6 mb-2">
                                                <a href="#" id="btnWhatsApp" target="_blank" rel="noopener" class="btn btn-whatsapp btn-block">
