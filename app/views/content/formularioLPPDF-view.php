<?php	
    ...
    class PDF extends FPDF {
        ...
        function Header() {
            ...
            $this->Cell(0, 6, mb_convert_encoding('FORMULARIO DE CONSENTIMIENTO INFORMADO DE RECOLECCIÓN ', 'ISO-8859-1', 'UTF-8'), 0, 1, 'R');
            $this->Cell(0, 6, mb_convert_encoding('Y TRATAMIENTO DE DATOS PERSONALES', 'ISO-8859-1', 'UTF-8'), 0, 1,'R');
    ...
    $titulo = mb_convert_encoding("ACADEMIA DE FÚTBOL PEDRO LARREA", 'ISO-8859-1', 'UTF-8');
    ...
    $text2 = mb_convert_encoding("En ACADEMIA DE FÚTBOL PEDRO LARREA, recolectamos y tratamos los datos personales de nuestros alumnos y sus representantes legales con las siguientes finalidades:", 'ISO-8859-1', 'UTF-8');
       
    // Escribir el texto en el PDF
    $pdf->MultiCell(0,5, $text2);

    $pdf->AddBullet(mb_convert_encoding('Gestión  administrativa y  operativa de la inscripción,  pagos mensuales y  participación  del  alumno  en las  actividades de  la ACADEMIA DE FÚTBOL PEDRO LARREA.', 'ISO-8859-1', 'UTF-8'),5);
    ...
    $pdf->SetX(15); // Posición X de la viñeta
    $pdf->Write(5, chr(149) . ' '); // Imprime el bullet (•)
    
    $pdf->SetX(20); // Ajusta la posición del texto
    $pdf->MultiCell(180, 5, mb_convert_encoding('Atención de situaciones de emergencia, incluyendo acceso a información de contacto y datos médicos básicos proporcionados por el representante legal.', 'ISO-8859-1', 'UTF-8'), 0, 'J'); // 'J' para justificar
    ...
    $pdf->AddBullet(mb_convert_encoding('Datos del alumno: Tipo de identificación, número de identificación, apellido paterno, apellido materno, primer nombre, segundo nombre, nacionalidad, fecha de nacimiento, dirección, tiene hermanos, género, fotografías del documento de identificación (anverso y reverso).', 'ISO-8859-1', 'UTF-8'),5);
    ...
    $pdf->AddBullet(mb_convert_encoding('Contenido audiovisual (fotos y videos): Se podrán tomar y usar imágenes de los alumnos en actividades propias de la ACADEMIA DE FÚTBOL PEDRO LARREA con fines promocionales o informativos.', 'ISO-8859-1', 'UTF-8'),5);
    ...
    $pdf->SetFont('Arial', '', 9);
    $text5 = mb_convert_encoding("La ACADEMIA DE FÚTBOL PEDRO LARREA adopta medidas de seguridad razonables y adecuadas para proteger los datos personales contra el acceso no autorizado, pérdida, destrucción, alteración o uso indebido.", 'ISO-8859-1', 'UTF-8');
    ...
    $pdf->SetFont('Arial', '', 9);
    $text6 = mb_convert_encoding("Declaro que he leído y comprendido los términos de este consentimiento y autorizo a la ACADEMIA DE FÚTBOL PEDRO LARREA a recolectar y tratar los datos personales mencionados, en los términos señalados en este documento.", 'ISO-8859-1', 'UTF-8');
    ...
    $pdf->SetFont('Arial', '', 9);
    $pdf->Cell(0, 5, '', 0, 2, 'L');
    $text7 = mb_convert_encoding("Sí, autorizo el uso de imágenes del alumno (fotos y videos) en las redes sociales y material promocional de la ACADEMIA DE FÚTBOL PEDRO LARREA.\n Sí, consiento el tratamiento de los datos personales del alumno con las finalidades descritas.", 'ISO-8859-1', 'UTF-8');
