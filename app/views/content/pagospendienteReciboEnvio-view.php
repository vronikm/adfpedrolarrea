<?php
	...
	// logo : 80 de largo por 55 de alto
        ...
        $pdf->SetXY( 46, 80 ); $pdf->SetFont( "Arial", "", 10 ); $pdf->Cell( 20, -3, mb_convert_encoding($datos['RUBRO']." ".$datos['TORNEO']." ".$datos['pago_periodo'].", ".$datos['transaccion_concepto'], 'ISO-8859-1', 'UTF-8'), 0, 0, 'L');
