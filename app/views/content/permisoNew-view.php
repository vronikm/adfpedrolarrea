<?php
	...
	if($rol_id != 0){
		$nombreRol=$insAsignar->BuscarRol($rol_id);		
...
<html lang="es">
  <head>
	...
	<title><?php echo APP_NAME; ?> | Asignar permisos</title>
      ...
      <div class="content-wrapper">
		...
		<div class="content-header">
			<div class="container-fluid">
				<div class="row mb-2">
					<div class="col-sm-6">
						<h4 class="m-0">Asignar nuevas opciones al rol <?php echo $rol_nombre ;?></h4>
					</div><!-- /.col -->
					<div class="col-sm-6">
