								...
								<div class="row invoice-info">
									<div class="col-sm-6 invoice-col">										
										<address class="text-center">												
											<img src="<?php echo APP_URL.'app/views/imagenes/fotos/sedes/'.$sede['sede_foto'] ?>" style="width: 200px; height: 200px;"/>									
										</address>
									</div>
									<!-- /.col -->
									...
									<div class="col-12 table-responsive">
										<table class="table table-striped table-sm">											
											<tbody>
												...
												<tr>													
													<td colspan="3">En ACADEMIA DE FÚTBOL PEDRO LARREA, recolectamos y tratamos los datos personales de nuestros alumnos y sus representantes legales con las siguientes finalidades:<br>
																	•	Gestión administrativa y operativa de la inscripción, pagos mensuales y participación del alumno en las actividades de la ACADEMIA DE FÚTBOL PEDRO LARREA.<br>
												...
												<tr>													
													<td colspan="3">La ACADEMIA DE FÚTBOL PEDRO LARREA adopta medidas de seguridad razonables y adecuadas para proteger los datos personales contra el acceso no autorizado, pérdida, destrucción, alteración o uso indebido.</td>												
												</tr>
												<tr>													
													<th>6. Consentimiento</th>																					
												</tr>	
												<tr>													
													<td colspan="3">Declaro que he leído y comprendido los términos de este consentimiento y autorizo a la ACADEMIA DE FÚTBOL PEDRO LARREA a recolectar y tratar los datos personales mencionados, en los términos señalados en este documento.</td>												
												</tr>
												<tr>
													<td></td>
												</tr>
												<tr>													
													<td colspan="3">Sí, autorizo el uso de imágenes de mi(s) representado(s) (fotos y videos) en las redes sociales y material promocional de la ACADEMIA DE FÚTBOL PEDRO LARREA.<br>
