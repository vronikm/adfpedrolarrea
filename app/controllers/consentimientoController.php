<?php
	 ...
	 * desde adfpedrolarrea_form. Acá se consultan todos y se registran los que
	 * la escuela recibe por otra vía (formulario en papel, correo), con origen
	 * ADMIN y el usuario que los ingresó.
	 */
