...
class inscripcionController extends mainModel
{
     ...
     *
     * Se reconocen por dos huellas, en OR: la observación que graba el
     * formulario y el consentimiento de origen FORMULARIO. La observación
     * cubre a los inscritos antes de que existiera alumno_consentimiento;
     * el consentimiento cubre el caso de que la observación se edite.
     */
    public function listarPendientesInscripcion($sedeid = '', $busqueda = '')
    {
        $interna = "SELECT a.alumno_id,
                           ...
                           r.repre_celular,
                           COALESCE(o.fecha_online, a.alumno_fecharegistro) AS fecha_online,
                           DATEDIFF(CURDATE(), DATE(COALESCE(o.fecha_online, a.alumno_fecharegistro))) AS dias_espera,
                      ...
                      LEFT JOIN (SELECT consent_alumnoid, MIN(consent_fecha) AS fecha_online
                     ...
                     WHERE a.alumno_estado = 'A'
                       AND (o.consent_alumnoid IS NOT NULL
                            OR a.alumno_observacion = 'Inscripción en línea')";
